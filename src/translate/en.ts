export const EN_translations = {
  ...
  text1: `This is my last job. Together my team, we got create a marketplace
  functional, accessible and easy to explore. Here, we ofert a platform 
  for the buyer and sellers can get your bussiness so easy and accessible for.
  The idea is what the people can digitalize your business to easy mode. The 
  <funny>spaninglish</funny> title
is deliberate. We want transmit to regional sense, the culture of the
