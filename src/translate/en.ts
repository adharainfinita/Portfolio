export const EN_translations = {
	...
	text1: `This is my last job whit a team. We created a marketplace functional, accessible and easy to explore. Here, we offer a platform for the buyer and sellers to get your business so easy and accessible for. The idea is that people can digitize your business to easy mode. We want to transmit in a regional sense, the culture of the place where we belong. In this repository you find the source code and the documentation associated with the development and functionalities of the app.`,
  ...
  The application uses an external API that provides the information of the countries.`,
	text3: `This was my first project as a fullstack developer. It's simple:
 you get characters from an external API, you save them in the database, also the created users, and you send them
 to the client`,
	text4: `This is a SPA where I promote my books as an author and editor. It is designed to transmit the brand's style and information in a dynamic way.`,
	section4: "Contact",
