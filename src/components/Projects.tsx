...
const Projects: React.FC<TranslationsProps> = ({translations}) => {
	...
	return (
		<div className=" h-auto bg-gradient-to-br border-4 border-stone-900 dark:border-0 from-light-ocean to-light-ciel dark:from-black dark:to-violet-Ocean flex flex-col items-center 
